  ...
  return (
    <div className="base-card product-crud-card">
      ...
      <div className='product-crud-card-description'>
        ...
        <div className="product-crud-category-container">
      ...
      <div className="product-crud-card-buttons-container">
        <button onClick={() => handleDelete(product.id)} className='btn btn-outline-danger product-crud-card-button product-crud-card-button-first'>EXCLUIR</button>
